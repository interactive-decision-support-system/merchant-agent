...
# through `merchant_catalog_table(...)` in `merchant_agent.merchant_agent`, which
...
# importable during app startup before merchant_agent.merchant_agent has finished loading.
# ---------------------------------------------------------------------------

def _catalog_table_for(merchant_id: Optional[str]) -> str:
    from merchant_agent.merchant_agent import merchant_catalog_table
